...
## 3.X 版本升级步骤 （最新版本3.4.14.0）
**注意点：3.3.8.0_to_3.4.8.0版本升级时间较长，大约十五分钟左右，其他版本升级时间大约为5分钟**

**请务必按照此顺序升级，后期将支持后台自动升级功能**

**升级顺序（需多次手动升级）：3.2.0.0→3.2.8.0→3.2.14.0→3.2.14.1→3.3.0.0→3.3.0.4→3.3.8.0→3.4.8.0→3.4.14.0**
...
### 旗舰版堡垒机--3.X版本升级包下载
[旗舰版堡垒机3.4.8.0\_to\_3.4.14.0版本升级包](https://uhas2017.cn-gd.ufileos.com/bastionhost_upgrade_3.4.8.0_to_3.4.14.0_x86_64_20210402_full.signature.tar)
