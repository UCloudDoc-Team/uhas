...
## 3.X 版本升级步骤 （最新版本3.3.5.0）

<WRAP center round alert 100%> **请务必按照此顺序升级，后期将支持后台自动升级功能**
</WRAP>**升级步骤：3.2.0.0→3.2.8.0→3.2.14.0→3.2.14.1→3.3.0.0→3.3.5.0**

![](/images/upgrade/3.x最新版本升级指导图.png)

### 旗舰版堡垒机--3.X版本升级包下载

[旗舰版堡垒机3.3.0.0\_to\_3.3.5.0版本升级包](http://uhas2017.cn-gd.ufileos.com/堡垒机_upgrade_3.3.0.0_to_3.3.5.0_2019-08-14.tar)
